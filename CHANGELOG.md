...
* #276 Implement integration with WatsonX LLM by @kkazmierczyk in https://github.com/IBM/javacore-analyser/pull/289

[3.0.2]: https://github.com/IBM/javacore-analyser/compare/3.0.1...3.0.2

## [3.0.1] - 2026-06-15
* #220 Adding Machine Learning feature for classifying javacore threads by @fchiossi in https://github.com/IBM/javacore-analyser/pull/261
* #265 Flask import error in batch mode when Flask not installed by @kkazmierczyk in https://github.com/IBM/javacore-analyser/pull/266
* #271 Processing har fails with IndexError: list index out of range by @kkazmierczyk in https://github.com/IBM/javacore-analyser/pull/272
* #269 Set root logger to DEBUG for wait2-debug.log by @kkazmierczyk in https://github.com/IBM/javacore-analyser/pull/270
* #268 jQuery tablesorter initialization for plugin-generated tables by @kkazmierczyk in https://github.com/IBM/javacore-analyser/pull/267
* #278 files called verbosegclog are not recognised by @PiotrAniola82 in https://github.com/IBM/javacore-analyser/pull/279
* #285 ML classification fails for thread snapshot in state UNKNOWN and issue #288 classify_javacore_inference causes a circular import. by @fchiossi in https://github.com/IBM/javacore-analyser/pull/287
* #280 support for tar files by @kkazmierczyk in https://github.com/IBM/javacore-analyser/pull/283
* #274 HAR file special characters handling by @kkazmierczyk in https://github.com/IBM/javacore-analyser/pull/275
* #290 detect system exit in main thread by @kkazmierczyk in https://github.com/IBM/javacore-analyser/pull/291
