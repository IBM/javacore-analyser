...
"""
Custom URI resolver for XSLT processing.

This module provides a FileResolver class that enables lxml's XSLT processor
to locate and include external XSL files referenced via <xsl:include> elements.
"""
