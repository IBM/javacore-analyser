...
class TestJavacoreSet(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dummy_javacore = Javacore()
        self.dummy_javacore.javacore_set = self.dummy_javacore_set

    def test_parse_mem_arg(self):
        line = "2CIUSERARG               -Xmx32g"
        mem = Javacore.parse_mem_arg(line)
    ...
    def test_parse_xmx(self):
        line = "2CIUSERARG               -Xmx32g"
        self.dummy_javacore.parse_xmx(line)
    ...
    def test_parse_xms(self):
        ...
        self.dummy_javacore.parse_xms(line)
    ...
    def test_parse_xmn(self):
        ...
        self.dummy_javacore.parse_xmn(line)
    ...
    def test_parse_gc_policy(self):
        ...
        self.dummy_javacore.parse_gc_policy(line)
    ...
    def test_parse_compressed_refs(self):
        ...
        self.dummy_javacore.parse_compressed_refs(line)
    ...
    def test_parse_verbose_gc(self):
        ...
        self.dummy_javacore.parse_verbose_gc(line)
    ...
    def test_parse_user_args(self):
        line = "2CIUSERARG               -Xmx32g"
        self.dummy_javacore.parse_user_args(line)
        self.assertEqual(self.dummy_javacore_set.xmx, "32g")
